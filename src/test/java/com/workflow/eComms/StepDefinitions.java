...
public class StepDefinitions extends TestBase {
    ...
    public void i_attach_a_file() throws Throwable {
        driver.findElement(By.id("fileUpload")).sendKeys("/Users/gideonlewis/Documents/Testing/testData");
    }
    ...
    public void i_verify_that_Contact_us_was_successful() throws Throwable {
        ...
        Files.copy(scrFile, new File("/Users/gideonlewis/Documents/Testing/Image1.jpg"));
    }
    ...
    @Given("^I click the Women link$")
    public void i_click_the_Women_link() throws Throwable {
        driver.findElement(By.xpath("//*[@id=\"block_top_menu\"]/ul/li[1]/a")).click();
    }

    @Given("^I click the subcategory Tops$")
    public void i_click_the_subcategory_Tops() throws Throwable {
        driver.findElement(By.xpath("//*[@id=\"subcategories\"]/ul/li[1]/div[1]/a/img")).click();
    }

    @Given("^I click on the Faded Short Sleeve T-shirts$")
    public void i_click_on_the_Faded_Short_Sleeve_T_shirts() throws Throwable {
        driver.findElement(By.xpath("//*[@id=\"center_column\"]/ul/li[1]/div/div[1]/div/a[1]")).click();
     }

    @Given("^I click the add quantity plus button$")
    public void i_click_the_add_quantity_plus_button() throws Throwable {
        driver.findElement(By.cssSelector("#quantity_wanted_p > a.btn.btn-default.button-plus.product_quantity_up")).click();
        Thread.sleep(1000);
    }

    @Given("^I select the shirt in a medium size$")
    public void i_select_the_shirt_in_a_medium_size() throws Throwable {
        Thread.sleep(2000);
    ...
    @When("^I click agree to Terms of service$")
    public void i_click_agree_to_Terms_of_service() throws Throwable {
        driver.findElement(By.xpath("//*[@id=\"center_column\"]/p[2]/a[1]")).click();
        Thread.sleep(1000);
    }

    @When("^I click the Pay by bank wire$")
    public void i_click_the_Pay_by_bank_wire() throws Throwable {
       // driver.findElement(By)
       // Thread.sleep(1000);
    }

    @When("^I click confirm my order$")
    public void i_click_confirm_my_order() throws Throwable {

    }

    @When("^I verify that order is completed$")
    public void i_verify_that_order_is_completed() throws Throwable {
